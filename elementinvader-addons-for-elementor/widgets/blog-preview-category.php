 ...
 * @since 1.1.0 
 */
class EliBlog_Preview_Category extends Elementinvader_Base {
    ...
    public function get_name() {
        return 'eli-blog-preview-category';
    }
    ...
    public function get_title() {
        return esc_html__('Eli Blog Preview Category', 'elementinvader-addons-for-elementor');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'is_link',
            [
                'label' => __( 'Enable Link', 'elementinvader-addons-for-elementor' ),
