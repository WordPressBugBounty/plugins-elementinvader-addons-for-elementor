 ...
 * @since 1.1.0
 */
class EliBlog_Preview_Title extends Elementinvader_Base {
    ...
    public function get_title() {
        return esc_html__('Eli Blog Preview Title', 'elementinvader-addons-for-elementor');
    }
    ...
    protected function register_controls() {
        ...
        $items = [
            [
                ...
                'selector_hide'=>'',
                'selector'=>'{{WRAPPER}} .eli_blog_preview_title',
                'selector_hover'=>'{{WRAPPER}} .eli_blog_preview_title:hover',
                'selector_focus'=>'',
                'options'=>'full',
            ]
        ];
